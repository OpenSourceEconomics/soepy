...
def test_non_employment_benefits_elterngeld_requires_newborn_child():
    spec = {
        "regelsatz_single": 0.0,
        "housing_single": 0.0,
        "housing_addtion": 0.0,
...
def test_non_employment_benefits_experience_grid_elterngeld_requires_newborn_child():
    spec = {
        "regelsatz_single": 0.0,
        "housing_single": 0.0,
        "housing_addtion": 0.0,
    ...
    expected = np.zeros((n_states, n_grid))
    np.testing.assert_allclose(out_no_male, expected)
